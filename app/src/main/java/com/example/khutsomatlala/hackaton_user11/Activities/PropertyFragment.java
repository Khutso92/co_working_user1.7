...
import com.example.khutsomatlala.hackaton_user11.adapter.PropertyAdapter;
...
public class PropertyFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        mDatabaseRefDetails = FirebaseDatabase.getInstance().getReference("property");

        //Init adapter
        adapter = new PropertyAdapter(workingSpaces, getActivity());
