...
import com.example.khutsomatlala.hackaton_user11.Activities.MainActivity;

public class Welcome_activity extends Activity implements View.OnClickListener {

    private ViewPager mPager;
    private int[] layouts = {R.layout.first_slide,R.layout.second_slide,R.layout.third_slide,R.layout.seventh,R.layout.fourth_slide,R.layout.firth,R.layout.sixth};
